...
class script(object):
    START_TXT = """
    👋 Hᴇʏ <a href=https://t.me/{} > </a>

ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ  ꜰɪʟᴇ ʙᴏᴛ ʟᴇᴛ'ꜱ ꜱɪᴍᴘʟɪꜰʏ ʏᴏᴜʀ ꜰɪʟᴇ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ .

<b>ᴅɪsᴄʟᴀɪᴍᴇʀ</b> - ᴡᴇ ᴅᴏɴ'ᴛ🙅‍♂ᴘʀᴏᴍᴏᴛᴇ ᴏʀ sᴜᴘᴘᴏʀᴛ ᴀɴʏ ᴋɪɴᴅ ᴏғ ɪʟʟᴇɢᴀʟ ᴏʀ ᴍɪsʟᴇᴀᴅɪɴɢ ᴄᴏɴᴛᴇɴᴛ/ᴘᴏsᴛ.
...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """    <b>
──────────
 Dᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/dankdev'>DankDev</a> 
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/danknet/5)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
"""
 ...
 <b>🌌ʜᴏᴡ ᴛᴏ ꜱᴇᴛ ᴛʜᴜᴍʙɴᴀɪʟ</b>

/set_thumb : ꜱᴇɴᴅ ᴀɴʏ ᴘʜᴏᴛᴏ ᴛᴏ ᴍᴇ, ᴀɴᴅ ɪ ᴡɪʟʟ ꜱᴀᴠᴇ ɪᴛ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ.
/delthumb : ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴏʟᴅ ᴛʜᴜᴍʙɴᴀɪʟ. 
/viewthumb : ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ᴠɪᴇᴡ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ ᴛʜᴜᴍʙɴᴀɪʟ.


<b>📝 ʜᴏᴡ ᴛᴏ ꜱᴇᴛ ᴄᴀᴘᴛɪᴏɴ</b>
...
<u> ɴᴏᴛᴇ:</u>
   ...
   /rename - ꜱᴇɴᴅ ᴀɴʏ ꜰɪʟᴇ ᴀɴᴅ ᴄʟɪᴄᴋ ʀᴇɴᴀᴍᴇ ᴏᴘᴛɪᴏɴ
"""

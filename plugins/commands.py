...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgIAAxkBAAIammZkXaHFnzHBcgpUI-4igsJgUsjoAALcAAP3AsgPUNi8Bnu98HweBA") 
    ...
    if data.split("-", 1)[0] == "DNA":
        user_id = int(data.split("-", 1)[1])
        DNA = await referal_add_user(user_id, message.from_user.id)
        if DNA and PREMIUM_AND_REFERAL_MODE == True:
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            try:
                ...
                filesarr.append(msg)
                k = await client.send_message(chat_id = message.from_user.id, text=f"</b>ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇꜱ/ᴠɪᴅᴇᴏꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ<b><u>10 ᴍɪɴꜱ</u> 🫥 <i></b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)</i>.")
            ...
            await asyncio.sleep(1) 
        await sts.delete()
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇꜱ/ᴠɪᴅᴇᴏꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ<b><u>10 ᴍɪɴꜱ</u> 🫥 <i></b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)</i>.")
        await asyncio.sleep(600)
        for x in filesarr:
            await x.delete()
        await k.edit_text("<b>Your All Files/Videos is successfully deleted!!!</b>")       
        ...
        for file in files:
            ...
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton('ᴅᴏᴡɴʟᴏᴀᴅ / ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ', callback_data=f'generate_stream_link:{file_id}') 
                ]]
            else:
                button = [[
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url=f'https://t.me/{SUPPORT_CHAT}'),
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇꜱ/ᴠɪᴅᴇᴏꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ<b><u>10 ᴍɪɴꜱ</u> 🫥 <i></b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)</i>.")
        await asyncio.sleep(600)
        for x in filesarr:
            await x.delete()
        await k.edit_text("<b>Your All Files/Videos is successfully deleted!!!</b>")
    ...
    if not files_:
        ...
        try:
            ...
            if STREAM_MODE == True:
                ...
                button = [[
                    InlineKeyboardButton(" DEV ", url="t.me/dankdev")
                ]]
            msg = await client.send_cached_media(
                chat_id=message.from_user.id,
                file_id=file_id,
            ...
            k = await msg.reply("\n This Movie File/Video will be deleted in <b><u>10 ᴍɪɴꜱ</u> <i></b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
            await k.edit_text("<b>ʏᴏᴜʀ ꜰɪʟᴇ/ᴠɪᴅᴇᴏ ɪꜱ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ!!!",reply_markup=InlineKeyboardMarkup(btn))
            return
        except:
            pass
    ...
    k = await msg.reply("\n This Movie File/Video will be deleted in <b><u>10 ᴍɪɴꜱ</u> 🫥 <i></b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)</i>.",quote=True)
    await asyncio.sleep(600)
    await msg.delete()
    await k.edit_text("<b>ʏᴏᴜʀ ꜰɪʟᴇ/ᴠɪᴅᴇᴏ ɪꜱ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ!!!",reply_markup=InlineKeyboardMarkup(btn))
    return   

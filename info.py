...
# Bot information
SESSION = environ.get('SESSION', 'botnetBot')
API_ID = int(environ.get('API_ID', '7140643'))
API_HASH = environ.get('API_HASH', '5ec4088f8e23d0ab61e29ae11960bf5')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6192787442').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tabolo8539:0evqZDV4fC5fD1o7c@cluster0.cw8zxus.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "botnetautobot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'botnetcollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://dnaezzz-7223f4ff33b5.herokuapp.com/')
PAYMENT_TEXT = environ.get('https://dnaezzz-7223f4ff33b5.herokuapp.com/')
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'dankdev') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/danknet')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/danknet')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/dankdev')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'dankdev') # Support Chat Link Without https:// or @
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'IDz0OwMkHLSxDUKHPXcn0X43Qt43')

# Others
MAX_B_TN = environ.get("MAX_B_TN", "5")
PORT = environ.get("PORT", "8080")
MSG_ALRT = environ.get('MSG_ALRT', 'ʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ DᴀɴᴋDᴇᴠ')
